...
// console.log(size)
  ...
  return (
    <header  className = { isOpen?` p-3 transition-all duration-500 ease-in-out 'bg-slate-100'}   md:sticky top-0 z-10  ` : 
                                  `transition-all duration-500 ease-in-out  md:bg-slate-100 text-white md:text-black '} md:sticky top-0 z-10`}>
